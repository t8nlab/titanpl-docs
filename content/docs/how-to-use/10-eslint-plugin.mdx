---
title: 10. ESLint Plugin
description: "ESLint plugin for Titan Planet projects. Enforces Titan Planet-specific rules including blocking Node.js built-in modules that are not available in the Gravity runtime."
---
...
const response = drift(t.fetch('https://api.example.com'));
...
// Without alternative:
"child_process" is not available in Titan Planet and has no direct alternative in Titan.
```
