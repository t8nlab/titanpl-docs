---
title: Actions
description: Execute request-aware business logic in JavaScript, TypeScript (Beta), or Rust, compiled and embedded into Titan’s native server.
---
...
JavaScript actions execute synchronously inside Titan’s embedded JavaScript engine.
